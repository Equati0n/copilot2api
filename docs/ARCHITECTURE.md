...
Copilot2API is a VS Code extension that registers chat models through `vscode.lm.registerLanguageModelChatProvider`.
...
2. Models are validated and stored under `copilot2api.models`.
